...
const DATA = {
  ...
  scenes: [
    ...
    { key: "impossible", title: "Creature or disaster shot", seconds: 5, takes: { lo: 15, c: 50, hi: 150 },
      ...
      body: ["When practical isn't possible, the comparison is AI against VFX, and heavy VFX is energy-hungry.  Weta's single longest shot on <i>Avatar: The Way of Water</i> took 13.6 million thread-hours.  Where the render farm sits matters as much: the same shot on New Zealand's mostly renewable grid emits about a quarter of what it would on the US grid.",
    ...
    { key: "dialogue", title: "Two people talking", seconds: 120, takes: { lo: 10, c: 30, hi: 300 },
      ...
      body: ["This is where AI's advantage disappears.  On a set that already exists, the scene adds only a few hours of lighting.",
             "Performance and lip-sync push rerolls up, and heavy rerolling puts AI above the practical footprint."],
  ...
  access: {
    ...
    // kg is a single figure, or {lo, c, hi} for an estimate with a range.
    rungs: [
    ...
    prose: [
      ...
      "One person generating a minute of Seedance 2.5 a day for a year emits about 480 kg CO2e, around a ninth of a UK resident's annual footprint.  That doesn't register on its own.  Scale changes the picture.  About 560 people at that pace match an indie feature every year, about 6,600 match a studio tentpole, and about 7 million match all the film and TV production in the world.",
      "The platforms that publish counts generated about 300–550 million seconds of video a day in early 2026, the same as 5–9 million people making a minute each, and xAI says Grok Imagine alone made 1.2 billion videos in 30 days.  Most of that runs on lighter models than Seedance.  At an average of 10 Wh per generated second, it comes to roughly 0.6 Mt CO2e a year, more than Netflix's whole production slate.  At Seedance's energy it would be 2.4–4.4 Mt, about as much as all the world's film and TV production.",
      "The fair comparison is all of filmmaking against all of AI video, and on that count filmmaking is still bigger.  Nobody publishes a global total, so we estimated one from UK, US, French, and Netflix data: roughly 2–6.5 Mt CO2e a year for all film and TV production, about 3.5 Mt at the center.  Disclosed AI video comes to about a sixth of that, or about a quarter of scripted film and TV alone.",
  ...
  localCompare: {
    cloud: [
      { model: "seedance25", res: "720p", label: "Seedance 2.5 · cloud", tip: "Seedance 2.5 at 720p in ByteDance's Johor data center" },
      { model: "minimaxH3", res: "768p", label: "MiniMax H3 · cloud", tip: "MiniMax H3 at 768p in a Chinese data center" },
      { model: "minimaxH3Max", res: "768p", label: "MiniMax H3 Max · cloud", tip: "MiniMax H3 Max, a distilled fast version, at 768p" },
      { gpuWh: { lo: 2.13, c: 2.17, hi: 2.25 }, region: "us", label: "Small Wan model · data center", tip: "Wan 2.1 1.3B at 832×480 on one H100: ML.ENERGY measured 18 Wh for 50 steps.  Scaled to 30 steps, plus servers and cooling." },
    ],
    local: [
      { label: "Mid-size Wan model, 720p · RTX 4090", wh: { lo: 13.1, c: 14.3, hi: 15.3 }, tip: "Wan 2.2 5B at 1280×704, 50 steps: 535 s on one RTX 4090 (Wan's own figure) at 420–520 W for the whole desktop" },
      { label: "Small Wan model · Mac mini", wh: { lo: 9.98, c: 9.98, hi: 9.98 }, tip: "Wan 2.1 1.3B at 832×480, 30 steps: measured 50.5 Wh at the chip in 3 h 25 min on a base M4 Mac mini.  The wall figure is higher." },
      { label: "Small Wan model · RTX 4090", wh: { lo: 3.6, c: 4.2, hi: 4.6 }, tip: "Wan 2.1 1.3B at 832×480: Wan's own 261 s on one RTX 4090 for 50 steps, scaled to 30 steps, at 420–520 W for the whole desktop.  About 21 Wh a clip." },
      { label: "LTX-2.3 · M4 Max laptop", wh: { lo: 1.2, c: 1.8, hi: 2.9 }, tip: "LTX-2.3 distilled at 1280×768: 6–15 Wh a clip, estimated from measured timings on other Apple chips" },
      { label: "LTX-Video · Mac mini", wh: { lo: 0.113, c: 0.113, hi: 0.113 }, tip: "LTX-Video 2B distilled at 768×512, 8 steps: measured 0.57 Wh at the chip in 2.3 min on a base M4 Mac mini" },
    ],
  },
  ...
  factorTable: [
    ...
    ["All film and TV production worldwide", "3.5 Mt CO2e a year", "2.0–6.5", "Our estimate from albert, the Sustainable Entertainment Alliance, Carbon'Clap, Netflix, BFI, Ampere, and WIPO data"],
